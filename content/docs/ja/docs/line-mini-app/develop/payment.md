...
:markdown-controlsLINEミニアプリに決済システムを組み込むことで、ユーザーに決済機能を提供できます。
...
| ------------------------------------ | --- | --- | --- |
| [LINE Pay](#line-pay)                | ❌   | ✅   | ✅   |
| [LINEミニアプリのアプリ内課金](#in-app-purchase) | ✅   | ❌   | ❌   |
| [その他の決済方法](#other-payment-methods)   | ✅   | ✅   | ✅   |
...
LINEミニアプリでLINE Payを利用するには、まずLINE Pay加盟店のアカウントが必要です。LINE Pay加盟店のアカウントがない場合は、[LINE Payの公式ホームページ](https://pay.line.me/portal/global/main){rel="[\"nofollow\"]"}から申し込んでください。
