...
__hash__: Uv_VYZYzOQFpH-yThsMA9kylIEtnaZffoKbkgNP1hI8
seo:
  title: LINEミニアプリとは
  description: LINEミニアプリは、LIFF上で実行されるウェブアプリです。
---
...
LINEミニアプリはウェブアプリですので、HTML5のほとんどの仕様が使用できます。詳しくは、「[仕様](/docs/line-mini-app/discover/specifications/)」を参照してください。
