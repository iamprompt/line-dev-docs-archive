...
__hash__: HF3vFZp-kVd6bIrXMh1wyvo_a3DBmMsXYzd5h_ufJO8
seo:
  title: iOS SDKリリースノート
  description: LINE SDK for iOSのリリースノートです。最新のリリースと変更点について記載しています。
---
...
:markdown-controls::admonition{title="バージョン5.0.0以降のリリースノートはGitHubリポジトリで公開しています" type="note"}
バージョン5.0.0以降のLINE SDK for iOSのリリースノートは、GitHubリポジトリで公開しています。詳しくは、[Releases](https://github.com/line/line-sdk-ios-swift/releases){rel="[\"nofollow\"]"}を参照してください。
::
...
- [LINE SDK for iOS Swiftリファレンス（英語）](/en/reference/ios-sdk-swift/)
- [LINE SDK for iOS Objective-Cリファレンス（英語）](/en/reference/ios-sdk-objc/)
...
- [LINE SDK for iOSガイド](/docs/line-login-sdks/ios-sdk/)
...
LINE SDK 5.0.0 for iOSがリリースされました。インストール方法と使い方については、『[LINE SDK for iOSガイド](/docs/line-login-sdks/ios-sdk/)』を参照してください。このガイドは、近日中に日本語化されます。
...
LINE SDK for iOS Swiftはオープンソース化されています。[リポジトリ](https://github.com/line/line-sdk-ios-swift){rel="[\"nofollow\"]"}にアクセスして、提供されているコードやサンプルを確認できます。
...
- Download with [CocoaPods](https://cocoapods.org/){rel="[\"nofollow\"]"}
