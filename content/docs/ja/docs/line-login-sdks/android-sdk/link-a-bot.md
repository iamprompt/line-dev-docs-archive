...
パラメータ値について詳しくは、『LINE SDK for Androidリファレンス（英語）』の「[LineAuthenticationParams.BotPrompt](/en/reference/android-sdk/reference/com/linecorp/linesdk/auth/LineAuthenticationParams.BotPrompt.html)」を参照してください。
...
戻り値について詳しくは、『LINE SDK for Androidリファレンス（英語）』の「[getFriendshipStatusChanged()](/en/reference/android-sdk/reference/com/linecorp/linesdk/auth/LineLoginResult.html#getFriendshipStatusChanged())」を参照してください。
...
戻り値について詳しくは、『LINE SDK for Androidリファレンス（英語）』の「[getFriendshipStatus()](/en/reference/android-sdk/reference/com/linecorp/linesdk/api/LineApiClient.html#getFriendshipStatus())」を参照してください。
