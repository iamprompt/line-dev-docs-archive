...
__hash__: qyC7_9INFFdiDhOlrBO8Lqph6KKnhex7MIL0lmocLgc
seo:
  title: LINE通知メッセージの概要
  description: >-
    LINE通知メッセージは、ユーザーのユーザーIDを知らなくても、ユーザーの電話番号を指定してメッセージを送信できるサービスです。ユーザーがLINE公式アカウントを友だち追加していなくても、LINE公式アカウントからメッセージを送信できます。
...
LINE通知メッセージには、用意されたテンプレートやアイテムを組み合わせて簡単にメッセージを作成できる[LINE通知メッセージ（テンプレート）](/docs/partner-docs/line-notification-messages/template/)と、事前にUX審査を要する[LINE通知メッセージ（フレキシブル）](/reference/line-notification-messages/#flexible)の2種類があり、それぞれ使用するAPIが異なります。
...
- [LINE通知メッセージAPIの技術仕様](/docs/partner-docs/line-notification-messages/technical-specs/)
