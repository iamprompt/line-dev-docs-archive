...
カスタムアイコンを使用して「LINEで送る」ボタンを作成できます。ボタンの設置方法について詳しくは、「[LINEで送るボタン](/docs/line-social-plugins/install-guide/using-line-share-buttons/#using-custom-icons)」を参照してください。  
...
:image-download## カスタムアイコンのデザインガイド

### 色

![色](/media/line-social-plugins/ja/guide_custom_icons.png)
