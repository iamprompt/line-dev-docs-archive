---
title: Get Number Of Reply Messages
navigation: true
description: ''
meta: '{}'
path: /ja/_partials/messaging-api/get-number-of-reply-messages
__hash__: xJgVehokagT5Dh1nXgIxEz6YJXEEmW2viS7fsGJ1QKU
seo:
  description: ''
---
...
:api-endpoint{protocol="get" endpoint="https://api.line.me/v2/bot/message/delivery/reply"}::reference-with-code
  :::reference-content
  [`/bot/message/reply`](#send-reply-message)エンドポイントを使って送信されたメッセージの数を取得します。
...
:api-playground{endpoint="/bot/message/delivery/reply"}#### レート制限
