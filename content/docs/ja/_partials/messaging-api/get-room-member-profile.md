...
description: ''
meta: '{}'
path: /ja/_partials/messaging-api/get-room-member-profile
__hash__: RrBts2SbnTUemfJ9pzLAhxMP6rvNjXjLleNo1uzfF1o
seo:
  description: ''
---
...
::reference-with-code
  ...
  | コード   | 説明                                                                                                                            |
  | ----- | ----------------------------------------------------------------------------------------------------------------------------- |
  | `400` | リクエストに問題があります。次のような理由が考えられます。- 無効なトークルームIDを指定している。 - 無効なユーザーIDを指定している。                                                        |
  | `404` | プロフィール情報を取得できませんでした。次のような理由が考えられます。- 存在しない複数人トークやLINE公式アカウントが参加していない複数人トークが指定されています。 - 存在しないユーザーや複数人トークに参加していないユーザーが指定されています。 |
