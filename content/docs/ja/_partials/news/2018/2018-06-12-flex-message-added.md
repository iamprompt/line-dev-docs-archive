...
navigation: true
description: >-
  Messaging APIの新しいメッセージタイプであるFlex Messageがリリースされました。Flex
  Messageは、複数の要素を組み合わせてレイアウトを自由にカスタマイズできるメッセージです。
meta: >-
...
詳しくは、「[Flex Messageを送信する](/docs/messaging-api/using-flex-messages/)」を参照してください。
