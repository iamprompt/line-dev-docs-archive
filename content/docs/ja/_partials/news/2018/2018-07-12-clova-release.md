...
navigation: true
description: >-
  本日、AIアシスタントClovaのスキルを誰でも開発できるClova Extensitons Kitを公開しました。あわせて公開したClova
  Developer Centerでは、チュートリアルや各種ドキュメントを参照できます。
meta: >-
...
詳しくは、Clova Developer Centerの[ドキュメント](https://clova-developers.line.biz/guide/){rel="[\"nofollow\"]"}を参照してください。
