...
__hash__: EF82_QWEkkkY_N1bZ0-glgaPcS3b_W5Kz-Q3SFB1Q8I
seo:
  title: LINEバージョン26.7.0から、LIFFブラウザのヘッダーの仕様が変更されました
  description: >-
    LINEバージョン26.7.0から、LINEミニアプリおよびLIFFアプリの表示に用いられるLIFFブラウザにおいて、ヘッダーの仕様が変更されました。今回の変更では、アクションボタンのアイコンとタップ時の挙動が変更されたほか、従来の最小化ボタンが閉じるボタンへと変更されています。
...
| 変更前                                                                                          | LINEバージョン26.7.0以降                                                                            |
| -------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| ![](/media/news/2026/action-button-tap-asis-ja.webp){className="[\"border\",\"w-fix-300\"]"} | ![](/media/news/2026/action-button-tap-tobe-ja.webp){className="[\"border\",\"w-fix-300\"]"} |
