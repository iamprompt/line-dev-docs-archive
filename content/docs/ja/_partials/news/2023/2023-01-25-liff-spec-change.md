---
title: 2023年2月6日をもってLIFFアプリに対するトークルームの内部識別子の提供を廃止します
navigation: true
description: >-
...
path: /ja/_partials/news/2023/2023-01-25-liff-spec-change
__hash__: vhhiWa6IrOR14-udCf_fC0HRvedsmpmSX6rMBV0Pprs
seo:
  title: 2023年2月6日をもってLIFFアプリに対するトークルームの内部識別子の提供を廃止します
  description: >-
    2022年12月27日にお知らせしたとおり、2023年2月6日をもって、LIFFアプリに対するトークルームの内部識別子（1対1トークID、グループID、トークルームID）の提供を廃止します。
...
[2022年12月27日](/news/2022/12/27/liff-spec-change/)にお知らせしたとおり、2023年2月6日をもって、LIFFアプリに対するトークルームの内部識別子（1対1トークID、グループID、トークルームID）の提供を廃止します。
...
- [影響1. `liff.getContext()`の戻り値](#impact-20230125-01)
- [影響2. LINEログインでアクセストークンを発行、更新、検証するAPIの戻り値](#impact-20230125-02)
...
現在、「[提供廃止の影響](#impact-20230125)」で示した内部識別子に依存したLIFFアプリを提供している場合、以下のような代替方法を検討してください。

- [トークルームの内部識別子の代わりに独自に発行したIDを使用する](#alternatives-20230125-01)
- [Webhookイベントに含まれるグループIDやトークルームIDを使用する](#alternatives-20230125-02)
