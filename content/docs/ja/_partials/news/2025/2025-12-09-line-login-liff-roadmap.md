...
2025年12月9日をもって、[LINEログイン](/docs/line-login/overview/)と[LINE Front-end Framework（LIFF）](/docs/liff/overview/)のロードマップの掲載を終了しました。

今後、機能追加やアップデートに関する情報は、[ニュース](/news/)にてお知らせします。
