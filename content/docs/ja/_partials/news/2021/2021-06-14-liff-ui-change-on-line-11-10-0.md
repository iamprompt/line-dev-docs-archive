...
| ブラウザ      | :glossary-tooltip[[LIFFブラウザ](/glossary/#liff-browser)]{glossary-id="liff-browser"}（:glossary-tooltip[[LINE内ブラウザ](/glossary/#line-iab)]{glossary-id="line-iab"}および:glossary-tooltip[[外部ブラウザ](/glossary/#external-browser)]{glossary-id="external-browser"}には適用されません。） |
| 画面サイズ     | すべての画面サイズ（`Compact`、`Tall`、`Full`）                                                                                                                                                                                                                                   |
