...
navigation: true
description: >-
  Flex Message Simulator Update 1（β）がリリースされました。Flex Message Update
  1で追加された新しいプロパティに対応し、より洗練されたレイアウトのサンプルメッセージも利用できます。
meta: >-
...
[Flex Message Simulator Update 1（β）](/flex-simulator/)がリリースされました。Flex Message Update 1で追加された新しいプロパティに対応し、より洗練されたレイアウトのサンプルメッセージも利用できます。
