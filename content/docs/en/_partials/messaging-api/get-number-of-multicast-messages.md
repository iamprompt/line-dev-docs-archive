---
title: Get Number Of Multicast Messages
navigation: true
description: ''
meta: '{}'
path: /en/_partials/messaging-api/get-number-of-multicast-messages
__hash__: kMPDEZe_8woPPAsrnwRPKDClO6BX3bSCJS8EBCRt8UA
seo:
  description: ''
---
...
:api-endpoint{protocol="get" endpoint="https://api.line.me/v2/bot/message/delivery/multicast"}::reference-with-code
  :::reference-content
...
:api-playground{endpoint="/bot/message/delivery/multicast"}#### Rate limit
