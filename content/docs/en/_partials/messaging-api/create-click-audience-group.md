...
description: ''
meta: '{}'
path: /en/_partials/messaging-api/create-click-audience-group
__hash__: 75oMHOkgK814qJNy4T_gnvdRuyPaWc64AECbVkcFdLo
seo:
  description: ''
---
...
:api-endpoint{protocol="post" endpoint="https://api.line.me/v2/bot/audienceGroup/click"}::reference-with-code
  ...
  Use a request ID to specify the message.
    ...
    ::::admonition{title="Message click audience" type="tip"}
