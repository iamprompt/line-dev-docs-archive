...
__hash__: mIMkjMVjrt04o0hYy5YugKyWI19wq0YHEhhboMSKeUc
seo:
  description: ''
---
...
::reference-with-code
  ...
  | Code  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
  | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
  | `400` | Couldn't send the message. Consider these reasons:- A user ID that doesn't exist in this channel is specified, such as a user ID obtained from channels under other providers. - A non-existent group or a group that your LINE Official Account doesn't participate in is specified. - A non-existent multi-person chat or a multi-person chat that your LINE Official Account doesn't participate in is specified. - An invalid message object is specified. - A unit name longer than the maximum number of characters (30) is specified in the `customAggregationUnits` property. - A unit name containing an invalid character is specified in the `customAggregationUnits` property. |
