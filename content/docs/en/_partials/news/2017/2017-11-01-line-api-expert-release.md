...
navigation: true
description: >-
  We have released the new "LINE API Expert" program which was announced at LINE
  Developer Day 2017. This program recognizes skilled engineers, who have a deep
  understanding of the various APIs provided by LINE and are active in the
  community, by giving them the title of "LINE API expert." To apply for the
...
seo:
  title: LINE API Expert program released
  description: >-
    We have released the new "LINE API Expert" program which was announced at
    LINE Developer Day 2017. This program recognizes skilled engineers, who have
    a deep understanding of the various APIs provided by LINE and are active in
    the community, by giving them the title of "LINE API expert." To apply for
    the program, visit the LINE API Expert page.
---

We have released the new "LINE API Expert" program which was announced at LINE Developer Day 2017. This program recognizes skilled engineers, who have a deep understanding of the various APIs provided by LINE and are active in the community, by giving them the title of "LINE API expert." To apply for the program, visit the [LINE API Expert](https://www.line-community.me/en/apiexpert){rel="[\"nofollow\"]"} page.
...
For more information about the incentives, see the [LINE API Expert](https://www.line-community.me/en/apiexpert){rel="[\"nofollow\"]"} page.
