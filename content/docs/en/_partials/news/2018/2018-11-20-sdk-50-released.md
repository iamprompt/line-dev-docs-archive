...
navigation: true
description: >-
  The LINE SDKs 5.0.0 for Android, iOS Swift, and iOS Objective-C have been
  released. For installation and usage instructions, see the following guides:
meta: >-
...
- [LINE SDK for Android guide](/docs/android-sdk/)
- [LINE SDK for iOS guide](/docs/ios-sdk/)
...
- [LINE SDK for Android reference](/reference/android-sdk/)
