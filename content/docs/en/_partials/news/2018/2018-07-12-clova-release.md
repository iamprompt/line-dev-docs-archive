...
navigation: true
description: >-
  We have released the CLOVA Extensions Kit that allows you to develop skills
  for CLOVA, AI assistant from LINE. We have also released the CLOVA Developer
  Center for tutorials and documentation in Japanese.
meta: >-
...
For more information, refer to the [documentation](https://clova-developers.line.biz/guide/){rel="[\"nofollow\"]"} on the CLOVA Developer Center.
