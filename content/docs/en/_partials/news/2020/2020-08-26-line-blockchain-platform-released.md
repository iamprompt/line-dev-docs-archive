...
navigation: true
description: >-
  The LINE Blockchain Platform, which consists of these three components, is now
  available.
...
seo:
  title: LINE Blockchain Platform is now available
  description: >-
    The LINE Blockchain Platform, which consists of these three components, is
    now available.
---

The LINE Blockchain Platform, which consists of these three components, is now available.

- [LINE Blockchain](#line-blockchain-news)
- [LINE Blockchain Developers](#line-blockchain-developers-news)
- [BITMAX Wallet](#bitmax-wallet-news)
...
Learn more about [LINE Blockchain](https://blockchain.line.me/){rel="[\"nofollow\"]"}.
...
Learn more about [LINE Blockchain Developers](https://blockchain.line.biz/){rel="[\"nofollow\"]"}.
...
Learn more about [BITMAX Wallet](https://wallet.bitmax.me/){rel="[\"nofollow\"]"}.
