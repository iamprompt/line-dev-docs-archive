...
- [Streamlined API references and documentation](#streamlined-api-ref-and-docs)
- [Updated `New` tag to alert users of unread announcements](#updated-new-tag)
- [Relocated language switch](#relocated-language-switch)
- [General header and side navigation improvements](#general-improvements)
