...
navigation: true
description: >-
  We added new endpoints to the Messaging API. These are the new features added
  to this update:
...
seo:
  title: Messaging API update for June 2020
  description: >-
    We added new endpoints to the Messaging API. These are the new features
...
- [Get group summary](#get-group-summary-news)
- [Get number of users in a group](#get-members-in-group-count-news)
- [Get number of users in a room](#get-members-in-room-count-news)
...
For more information, see [Get number of users in a room](/reference/messaging-api/#get-members-room-count) in the Messaging API reference.
