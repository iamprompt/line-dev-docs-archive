...
navigation: true
description: >-
  The LINE Developers site's Messaging API reference page, due to the large
...
The LINE Developers site's [Messaging API reference](/reference/messaging-api/) page, due to the large amount of endpoints, was long and difficult to navigate.
