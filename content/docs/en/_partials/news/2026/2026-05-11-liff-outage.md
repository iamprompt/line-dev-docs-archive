...
April 27, 2026 (ongoing)

## Cause of the outage

Bug in LINE for Android version 26.6.0 or 26.6.1

## Details

The following issues are occurring in LIFF/LINE MINI Apps under specific conditions:

- User profiles cannot be retrieved
- The LIFF API is not working properly
