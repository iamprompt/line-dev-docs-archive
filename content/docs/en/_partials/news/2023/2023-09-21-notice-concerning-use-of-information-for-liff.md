...
navigation: true
description: >-
  Thank you very much for always using the share target picker
  (liff.shareTargetPicker()) of LINE Front-end Framework (LIFF).
...
Thank you very much for always using the [share target picker](/docs/liff/developing-liff-apps/#using-share-target-picker) ([`liff.shareTargetPicker()`](/reference/liff/#share-target-picker)) of LINE Front-end Framework (LIFF).
