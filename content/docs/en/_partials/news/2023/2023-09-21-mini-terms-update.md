...
In addition, some changes will be made to the [LINE MINI App Platform Terms of Use](https://terms2.line.me/LINE_Developers_MINI_App_JP?country=JP&lang=en){rel="[\"nofollow\"]"} on the same date. Such changes include change of the company name and title of the privacy policy in association to the Reorganization, as well as change of the article regarding revision of the terms of use. For details on the changes, please review the new LINE MINI App Platform Terms of Use.
