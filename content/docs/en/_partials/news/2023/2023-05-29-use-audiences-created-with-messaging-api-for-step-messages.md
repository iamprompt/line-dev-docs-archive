...
navigation: true
description: >-
  You can now use audiences created with the Messaging API for step messages in
...
You can now use audiences created with the Messaging API for step messages in the [LINE Official Account Manager](https://manager.line.biz/){rel="[\"nofollow\"]"}.
...
For more information about audiences that can be created with the Messaging API, see [Creating audiences](/docs/messaging-api/using-audience/#create-audience) in the Messaging API documentation.
