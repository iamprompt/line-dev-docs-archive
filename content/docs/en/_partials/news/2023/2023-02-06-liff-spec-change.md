...
title: >-
  ...
  rooms to LIFF apps as of February 6, 2023
navigation: true
description: ''
meta: >-
...
::admonition{title="Updated on February 10, 2023" type="note"}
We've replaced the link to Security & Privacy in the [Impact of discontinuing](#impact-20230206).
::

::admonition{title="Updated on February 7, 2023" type="note"}
We've updated the [Impact of discontinuing](#impact-20230206).
::

As announced on [December 27, 2022](/news/2022/12/27/liff-spec-change/) and [January 25, 2023](/news/2023/01/25/liff-spec-change/), we've discontinued providing company internal identifiers of chat rooms (one-on-one chat ID, group ID, and room ID) to LIFF apps as of February 6, 2023.
...
- [Impact 1: Return value of `liff.getContext()`](#impact-20230206-01)
- [Impact 2: Return values of APIs that issue, refresh, or verify the validity of LINE Login access tokens](#impact-20230206-02)

If you have saved the company internal identifiers of chat rooms that are no longer provided, delete them. For more information, see [Notice and apology regarding LINE chat identifiers shared with third parties](https://linecorp.com/en/security/article/444){rel="[\"nofollow\"]"} in Security & Privacy.
...
If you're currently providing LIFF apps that rely on the company internal identifiers described in the [Impact of discontinuing](#impact-20230206) section above, you should consider the following alternatives:

- [Issue unique ID by your service instead of using the chat room identifiers](#alternatives-20230206-01)
- [Use group ID / room ID included in webhook events](#alternatives-20230206-02)
