---
title: >-
  On LINE for iOS version 14.15.1 or later, you can now minimize LINE MINI Apps
  from the header
navigation: true
description: >-
  On LINE for iOS version 14.15.1 or later, you can now minimize LINE MINI Apps
...
![](/media/news/2024/change-from-close-to-minimize.png){className="[\"w-fix-520\"]"}
...
The conditions for minimizing the LINE MINI App are based on the [Conditions of use for LIFF browser minimization](/docs/liff/minimizing-liff-browser/#conditions-of-use).
...
For more information on how to minimize, see [Minimizing LIFF browser](/docs/liff/minimizing-liff-browser/) in the LIFF documentation.
