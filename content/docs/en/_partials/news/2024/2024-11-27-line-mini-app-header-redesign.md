...
title: >-
  ...
  background color" feature has been discontinued
navigation: true
description: ''
meta: >-
...
As announced on [October 10, 2024](/news/2024/10/10/line-mini-app-header-redesign/), due to the redesign of the LINE MINI App header, the "Header background color" feature has been discontinued.
...
- In LINE MINI App channels of the [LINE Developers Console](/console/), the "Header background color" section has been removed from the **LIFF** tab and the "Header background color" feature is no longer available.
