...
navigation: true
description: >-
  In order to start providing unverified MINI Apps (*), we plan to make
  significant changes to the user interface in LINE MINI App channels of the
  LINE Developers Console. As a result, we will temporarily suspend review for
  LINE MINI Apps during the following period. We sincerely apologize for any
...
In order to start providing unverified MINI Apps (*), we plan to make significant changes to the user interface in LINE MINI App channels of the [LINE Developers Console](/console/). As a result, we will temporarily suspend review for LINE MINI Apps during the following period. We sincerely apologize for any inconvenience that this may cause and thank you for your understanding.
