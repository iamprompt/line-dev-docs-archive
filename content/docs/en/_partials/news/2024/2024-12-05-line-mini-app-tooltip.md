...
__hash__: sUh9WuN6kmVjj0Fmczd2HBw_P9tVOzczHD5VY3ALnqA
seo:
  title: LINE MINI Apps now display a tooltip for adding shortcuts to the home screen
  description: >-
    Verified MINI Apps on LINE MINI Apps now display a tooltip for adding a
...
![The tooltip has a notice that says, “You can add this MINI App to your home screen.” and a button to add a shortcut to the home screen and a button to close the tooltip.](/media/news/2024/line-mini-app-header-tooltiop-en.webp){className="[\"border\",\"w-fix-280\"]"}
