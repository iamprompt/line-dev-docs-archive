...
title: >-
  ...
  Share button on a computer from Keep to Keep Memo
navigation: true
description: >-
  In the LINE Social Plugins, when you click the Share button on your computer,
...
seo:
  title: >-
    ...
    Share button on a computer from Keep to Keep Memo
  description: >-
    In the LINE Social Plugins, when you click the Share button on your
    computer, a pop-up will appear to select the destination.
---

In the [LINE Social Plugins](/docs/line-social-plugins/general/overview/), when you click the Share button on your computer, a pop-up will appear to select the destination.
