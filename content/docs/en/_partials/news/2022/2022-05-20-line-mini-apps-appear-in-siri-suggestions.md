...
::admonition{title="What is "Siri Suggestions"" type="tip"}
This feature suggests shortcuts or provides suggestions based on the user's routines and app usage by Siri. For more information, see [Siri Suggestions on iPhone](https://support.apple.com/guide/iphone/about-siri-suggestions-iph6f94af287/15.0/ios/15.0){rel="[\"nofollow\"]"} in Apple Support.
::
