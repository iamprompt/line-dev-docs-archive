...
navigation: true
description: >-
  In the LINE Developers Console, the tab name of the LINE MINI App channel has
...
__hash__: lDbHGdDoVCzGCi7GNvnKbhIyrzDUr_uWe7U-l7V9CPU
seo:
  title: >-
    In the LINE Developers Console, we've reorganized the tabs of the LINE MINI
    App channel
  description: >-
    In the LINE Developers Console, the tab name of the LINE MINI App channel
    has been changed, input fields have been moved and other changes have been
    made.
---

In the [LINE Developers Console](/console/), the tab name of the LINE MINI App channel has been changed, input fields have been moved and other changes have been made.
...
1. [Changed the tab name](#change-tab-name-20220728)
2. [Moved the Function category to the Basic settings tab](#move-function-category-20220728)
3. [Changed the input field of reference materials for review](#change-materials-20220728)
...
![LINE MINI App channel tab](/media/news/2022/line-mini-app-channel-tab-en.png){className="[\"border\",\"w-fix-640\"]"}
...
For more information about the LINE MINI App, see [LINE MINI App documentation](/docs/line-mini-app/).
