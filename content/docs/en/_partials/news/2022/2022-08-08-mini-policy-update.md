---
title: >-
  In the LINE MINI App, we've changed our policy on user inducement to external
  services
navigation: true
description: >-
  In the LINE MINI App, we've changed our policy on user inducement to external
...
For more information about policy on user inducement to external services, see [On User Inducement](/docs/line-mini-app/submit/line-mini-app-policy/#user-inducement) in the LINE MINI App Policy.
