---
title: >-
  On LINE for iOS version 12.19.0 or later, we'll be making changes to the UI of
...
__hash__: Xsg8mj6tc-KjgimmHPJLyT47YGfs7uJeB7tcak0J18k
seo:
  title: >-
    On LINE for iOS version 12.19.0 or later, we'll be making changes to the UI
    of the action button in the LIFF browser
  description: >-
    On LINE for iOS version 12.19.0 or later, we'll be making changes to the UI
    of the action button in the LIFF browser.
---

On LINE for iOS version 12.19.0 or later, we'll be making changes to the UI of the [action button](/docs/liff/overview/#action-button) in the :glossary-tooltip[[LIFF browser](/glossary/#liff-browser)]{glossary-id="liff-browser"}.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![The action button on LINE for iOS version earlier than 12.19.0](/media/news/2022/action-button-before-en-20221109.webp){className="[\"w-fix-320\"]"} | ![The action button on LINE for iOS version 12.19.0 or later](/media/news/2022/action-button-after-en-20221109.webp){className="[\"border\",\"w-fix-320\"]"} |
