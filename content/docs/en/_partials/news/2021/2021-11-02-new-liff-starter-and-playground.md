...
navigation: true
description: >-
  We've released a new LIFF starter app and LIFF Playground to help developers
...
For more information, see [LIFF starter app](https://github.com/line/line-liff-v2-starter){rel="[\"nofollow\"]"}.
...
For more information, see [LIFF Playground](https://liff-playground.netlify.app/){rel="[\"nofollow\"]"}.
