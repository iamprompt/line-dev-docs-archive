...
For more information about safe areas, see [Layout Guides and Safe Area](https://developer.apple.com/design/human-interface-guidelines/foundations/layout/){rel="[\"nofollow\"]"} on the Apple Developer site.
::
