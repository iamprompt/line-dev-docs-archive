...
navigation: true
description: >-
  We have improved the consent screen bundled with the LINE Front-end Framework
  (LIFF). The improvement is automatically applied to all LIFF apps. There's no
...
seo:
  title: Improved consent screen in LINE Front-end Framework
  description: >-
    We have improved the consent screen bundled with the LINE Front-end
    Framework (LIFF). The improvement is automatically applied to all LIFF apps.
