...
navigation: true
description: >-
  As previously announced, today we released a new version of the LINE
  Developers Console.
...
As previously announced, today we released a new version of the [LINE Developers Console](/console/).
...
![Screenshot of Basic settings and Messaging API tabs](/media/news/new-console-basic-settings-tab.png)
...
![Screenshot of search field at top of provider list](/media/news/new-console-provider-search.png)
...
![Screenshot of Roles tab in channel information](/media/news/new-console-roles-tab.png)
