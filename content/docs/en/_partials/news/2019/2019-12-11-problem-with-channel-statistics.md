...
navigation: true
description: >-
  There was an issue with the Statistics tab for Messaging API channels on the
  LINE Developers Console. Due to an inconsistency in how the system handled
  timezones, the tab appeared to show different data for certain days than the
