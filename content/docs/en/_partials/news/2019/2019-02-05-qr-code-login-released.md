...
navigation: true
description: >-
  Web apps that use LINE Login v2.1 now allow users to log in by scanning a QR
  code on the login screen. They can scan the QR code with LINE on their
  smartphones. As before, they can also log in with their email address and
  password.
