...
navigation: true
description: >-
  Depending on the browser policy, the Social Plugins' "Like" button may not
  work on the mobile version of the browser. This is a problem not only for LINE
  Social Plugins, but also for all similar services, and it can be solved by
  changing the settings of the mobile app.
meta: >-
...
seo:
  ...
  description: >-
    Depending on the browser policy, the Social Plugins' "Like" button may not
    work on the mobile version of the browser. This is a problem not only for
    LINE Social Plugins, but also for all similar services, and it can be solved
    by changing the settings of the mobile app.
---
