...
navigation: true
description: >-
  Using the Messaging API, you can send only the stickers listed in the
  Stickers.
meta: >-
...
Using the Messaging API, you can send only the stickers listed in the [Stickers](/docs/messaging-api/sticker-list/).
