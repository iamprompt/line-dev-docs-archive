...
navigation: true
description: >-
  You can find your Channel ID on the LINE Official Account Manager or the LINE
  Developers Console.
meta: >-
...
seo:
  title: Where can I find my Channel ID?
  description: >-
    You can find your Channel ID on the LINE Official Account Manager or the
    LINE Developers Console.
---

You can find your Channel ID on the [LINE Official Account Manager](https://manager.line.biz/){rel="[\"nofollow\"]"} or the [LINE Developers Console](/console/).
