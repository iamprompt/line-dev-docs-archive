...
For more information on sending methods that are counted towards the message count, see [Chargeable Messages](https://www.lycbiz.com/jp/service/line-official-account/plan/){rel="[\"nofollow\"]"} (only available in Japanese) in LINE for Business.
