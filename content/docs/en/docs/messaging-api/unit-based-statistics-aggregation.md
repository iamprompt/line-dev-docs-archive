...
:markdown-controlsYou can get statistics per aggregation unit of how users interact with [push messages](/reference/messaging-api/#send-push-message) and [multicast messages](/reference/messaging-api/#send-multicast-message) you send to multiple users.
...
You can get user interaction statistics for push messages and multicast messages sent with unit names by using the [Get statistics per unit](/reference/messaging-api/#get-statistics-per-unit) endpoint. Here is an example request to get statistics of a unit named `promotion_a`:
...
In addition, you can get a list of unit names assigned in this month by using the [Get a list of unit names assigned during this month](/reference/messaging-api/#get-a-list-of-unit-names-assigned-during-this-month) endpoint. There is no endpoint to check unit names assigned before the previous month.
...
By using the Get user interaction statistics endpoint, you can get statistics about how users interact with narrowcast messages or broadcast messages sent from your LINE Official Account. For more information, see [Get user interaction statistics](/reference/messaging-api/#get-message-event) in the Messaging API reference.
