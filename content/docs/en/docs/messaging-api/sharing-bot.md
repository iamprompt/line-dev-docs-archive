...
The LINE Social Plugins generates a piece of code for the [Add Friend button](/docs/line-social-plugins/install-guide/using-add-friend-buttons/). All you need to do to add it is copy and paste the code in your app or website. This button is available in multiple languages. You can also display the number of friends that your LINE Official Account has, and add a link to the home page of your LINE Official Account.
