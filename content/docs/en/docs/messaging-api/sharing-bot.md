...
__hash__: L59bcpeNc6HUQlB-a3PO2l-4gF27Rp6tmWddumFjAcs
seo:
  title: Gain friends of your LINE Official Account
  description: null
---
...
![](/media/messaging-api/sharing-bot/qr-code-oa-manager-en.png){className="[\"border\",\"w-fix-720\"]"}
...
![](/media/messaging-api/sharing-bot/add-friend-button-oa-manager-en.png)
...
![If bot_prompt=normal, the option to add a friend is displayed on the consent screen. If bot_prompt=aggressive, the option to add a friend is displayed after the user has consented.](/media/line-login/link-a-bot/bot-prompt-en.png){className="[\"w-fix-840\"]"}
