...
:markdown-controlsYou can customize the icon and display name of your LINE Official Account on messages you send with these APIs. There is no restriction on the type of [Message objects](/reference/messaging-api/#message-objects).

- [Send push messages](/reference/messaging-api/#send-push-message)
- [Send multicast messages](/reference/messaging-api/#send-multicast-message)
- [Send narrowcast messages](/reference/messaging-api/#send-narrowcast-message)
- [Send broadcast messages](/reference/messaging-api/#send-broadcast-message)
- [Send reply messages](/reference/messaging-api/#send-reply-message)
...
![](/media/messaging-api/icon-nickname-switch/icon-nickname-switch.jpg){className="[\"border\"]"}
...
For more information about the specification of customizing the icon and display name, see [Change icon and display name](/reference/messaging-api/#icon-nickname-switch) in the Messaging API reference.
