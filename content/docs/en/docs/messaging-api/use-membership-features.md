---
title: Use membership features
navigation: true
description: null
meta: '{"tags":null,"author":null,"last_updated":null,"source_language":null}'
path: /en/docs/messaging-api/use-membership-features
__hash__: JeHarwxQBjMvJeqiA-_adXi10l3ZFxrZ4dbWZxHdzok
seo:
  title: Use membership features
  description: null
---
...
This endpoint allows you to get a list of user IDs for users who have joined the membership of your LINE Official Account. For more information, see [Get a list of users who have joined the membership](/reference/messaging-api/#get-membership-user-ids) in the Messaging API reference.
...
When a user joins, renews, or leaves a membership of your LINE Official Account, a webhook membership event is sent. For more information, see [Membership event](/reference/messaging-api/#membership-event) in the Messaging API reference.
