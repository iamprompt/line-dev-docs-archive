...
- [Can users add a LINE MINI App icon to their device's home screen?](/faq/#can-i-add-line-mini-app-icon-to-home-screen)
- [Does it cost money to send notifications to users from LINE MINI Apps?](/faq/#does-it-cost-money-to-send-notifications-with-line-mini-apps)
- [Can users access LINE MINI Apps without installing the LINE app?](/faq/#can-users-who-do-not-use-line-use-line-mini-apps)
- [Can I migrate a web app or LIFF app to a LINE MINI App?](/faq/#can-i-migrate-a-web-app-or-liff-app-to-line-mini-app)
- [Is there any benefit to using LINE MINI Apps alongside an existing native app?](/faq/#is-there-any-benefit-to-using-line-mini-apps-with-native-app)
