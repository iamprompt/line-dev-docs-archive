...
__hash__: I17s_CgtEVqONG4WbMzk2izPZKl2bb0OLgBwuxDpvuM
seo:
  title: Getting started
  description: null
---
...
![LINE MINI App channel](/media/line-mini-app/line-mini-app-channel-en.webp){className="[\"w-fix-720\",\"border\"]"}
...
| **Channel name**                        | ✅               | The channel's name   *Channel name can't contain "LINE" or similar strings.                                                                                                                                                                                                                                | - [Header](/docs/line-mini-app/discover/ui-components/#header) for verified MINI Apps   - Permission consent screen when launching LINE MINI App   - The target chat room when you use an [action button](/docs/line-mini-app/develop/configure-console/#built-in-share-settings) to share a LINE MINI App page   - [Multi-tab view](/docs/line-mini-app/develop/configure-console/#multi-tab-view-settings)   - Footer section of the [Service message](/docs/line-mini-app/develop/service-messages/#template-elements)   - [Discover the LINE MINI App (Home tab, search feature, etc.)](/docs/line-mini-app/discover/introduction/#access-line-mini-app-methods-for-users)   - [Add Shortcut screen](/docs/line-mini-app/develop/configure-console/#add-shortcut-screen) |
