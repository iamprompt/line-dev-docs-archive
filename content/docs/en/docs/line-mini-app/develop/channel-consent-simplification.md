...
The "Channel consent simplification" feature applies only to the permission to get the :glossary-tooltip[[user ID](/glossary/#user-id)]{glossary-id="user-id"} (the `openid` scope). Permissions required to get user profile information or send messages (such as [the `profile` scope and the `chat_message.write` scope](/docs/liff/registering-liff-apps/#registering-liff-app)) aren't included in the feature. For these additional permissions, the verification screen is displayed within each LINE MINI App at the time the permissions are needed. For more information, see [Request permissions other than the `openid` scope on the verification screen](#request-permissions-other-than-openid).
...
![](/media/line-mini-app/simplification-feature-setup-en.webp){className="[\"border\",\"w-fix-760\"]"}
...
If additional permissions are required, see [Request permissions other than the `openid` scope on the verification screen](#request-permissions-other-than-openid).

![](/media/line-mini-app/channel-consent-simplification/authorization-flow-enabled-en.webp){className="[\"border\",\"w-fix-960\"]"}
...
![](/media/line-mini-app/line-mini-app-playground-verification-screen-en.webp){className="[\"border\",\"w-fix-320\",\"inline-block\"]"}
...
![](/media/line-mini-app/channel-consent-simplification/line-mini-app-playground-channel-consent-screen-en.webp){className="[\"border\",\"w-fix-320\"]"}
