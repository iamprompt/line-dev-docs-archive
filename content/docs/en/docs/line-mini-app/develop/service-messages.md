...
![LINE MINI App Notice](/media/line-mini-app/mini-service-messages-en.png){className="[\"border\",\"w-fix-280\"]"}
...
![You can check service message templates in the console](/media/line-mini-app/service-message-template-en.png){className="[\"border\"]"}
...
![Changes to JSON are reflected in the preview](/media/line-mini-app/preview-service-message-en.png){className="[\"bg-border\"]"}
