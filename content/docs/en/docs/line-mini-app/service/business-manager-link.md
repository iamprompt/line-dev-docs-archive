...
:markdown-controlsYou can link a LINE MINI App channel to a [Business Manager](https://www.lycbiz.com/jp/service/business-manager/){rel="[\"nofollow\"]"} organization. Once linked, you can integrate with accounts of other services linked to the same organization.

Currently, the only supported integration is with LINE Official Accounts. We plan to expand the available features in the future, including the ability to display information about your LINE MINI App on the [business profile](https://www.lycbiz.com/jp/manual/OfficialAccountManager/profile/){rel="[\"nofollow\"]"} of a linked LINE Official Account.

For more information about the Business Manager, see [Business Manager](https://www.lycbiz.com/jp/service/business-manager/){rel="[\"nofollow\"]"} (only available in Japanese) in LY for Business.

:toc## Requirements for linking to a Business Manager organization

To link a LINE MINI App channel to a Business Manager organization, all of the following conditions must be met:

- The LINE MINI App is a ::glossary-tooltip{glossary-id="verified-mini-app"}
[verified MINI App](/glossary/#verified-mini-app)
::
...
::admonition
---
title: You can't remove the link to a Business Manager organization
type: note
---
Once a LINE MINI App channel is linked to a Business Manager organization, the link can't be removed. However, you can transfer the LINE MINI App channel to another organization in the Business Manager. For more information, see [Can I transfer a linked account or channel to another organization?](https://help.linebiz.com/lineadshelp/s/article/L000001731?language=ja){rel="[\"nofollow\"]"} (only available in Japanese) in LINE for Business.
::

The process for linking a LINE MINI App channel to a Business Manager organization is as follows:

1. [A developer sends a link request](#send-link-request)
2. [A developer sends the link request URL to the Business Manager organization administrator](#send-link-request-url)
3. [The Business Manager organization administrator approves the request](#approve-request)

In the following steps, you'll use both the LINE Developers Console and the Business Manager. The LINE Developers Console must be operated by a [developer](/docs/line-developers-console/overview/#developer) with the Admin role for the LINE MINI App channel, and the Business Manager must be operated by the organization administrator.
...
::admonition{title="Find the organization ID" type="tip"}
...
![](/media/line-mini-app/service/business-manager-header-en.png){className="[\"border\"]"}
::
...
::admonition{title="Link request URL validity period" type="tip"}
...
Once the account linking review is completed and the [status](#account-linking-review-status) becomes verified, you can integrate with accounts of other services linked to the same organization.
...
For more information about the Business Manager organization verification review, see [03. Organization verification review](https://www.lycbiz.com/jp/manual/BusinessManager/BMshare004/?list=21791){rel="[\"nofollow\"]"} (only available in Japanese) in LY for Business and [When does the Business Manager review start, what does it review, and how long does it take?](https://help.linebiz.com/lineadshelp/s/article/L000001858?language=ja){rel="[\"nofollow\"]"} (only available in Japanese) in LINE for Business.
...
For more information, see [If the account linking review is rejected](#account-linking-review-status-rejected).
...
| Status     | Description                                                                                                                                                                                                                                 |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Unverified | The [requirements for starting an account linking review](#account-linking-review-requirements) aren't met. The account linking review starts once the organization verification review is completed and the organization becomes verified. |
| Verified   | The account linking review has been completed.                                                                                                                                                                                              |
| Rejected   | The account linking review was rejected. For more information, see [If the account linking review is rejected](#account-linking-review-status-rejected).                                                                                    |
...
- [If the business information of the LINE MINI App channel is incorrect](#account-linking-review-status-rejected-line-mini-app)
- [If the business info of the Business Manager organization is incorrect](#account-linking-review-status-rejected-business-manager)
- [If the LINE MINI App channel is linked to the wrong Business Manager organization](#account-linking-review-status-rejected-wrong-organization)

#### If the business information of the LINE MINI App channel is incorrect

Update the business information of the LINE MINI App channel with the correct information. Updating the business information requires a re-review of the LINE MINI App. For more information, see [Re-review after updating your verified MINI App](/docs/line-mini-app/service/update-service/).

After the re-review of the LINE MINI App is completed and the updates have been applied to the LINE MINI App channel for Published, request an [account linking review resubmission](#account-linking-review-resubmission).

#### If the business info of the Business Manager organization is incorrect

- [If the Business Manager organization is unverified](#account-linking-review-status-rejected-business-manager-unverified)
- [If the Business Manager organization is verified](#account-linking-review-status-rejected-business-manager-verified)
...
After the organization verification review is completed, request an [account linking review resubmission](#account-linking-review-resubmission).
...
After the organization is transferred, the account linking review starts if the destination organization meets the [requirements for starting an account linking review](#account-linking-review-requirements).

#### If the LINE MINI App channel is linked to the wrong Business Manager organization

Transfer the LINE MINI App channel to the correct Business Manager organization. For more information, see [Can I transfer a linked account or channel to another organization?](https://help.linebiz.com/lineadshelp/s/article/L000001731?language=ja){rel="[\"nofollow\"]"} (only available in Japanese) in LINE for Business.
...
- The LINE MINI App channel is linked to a Business Manager organization, and the [account linking review status](#account-linking-review-status) is verified.
- The LINE Official Account is linked to a Business Manager organization, and the [account linking review status](#account-linking-review-status) is verified (*).
- The LINE MINI App channel and the LINE Official Account are linked to the same Business Manager organization.

* For more information on how to link a LINE Official Account to a Business Manager organization, see [02. Link an account to an organization](https://www.lycbiz.com/jp/manual/BusinessManager/BMshare003/){rel="[\"nofollow\"]"} (only available in Japanese) in LY for Business.

### How to link to a LINE Official Account

::admonition
---
title: You can't remove the link to a LINE Official Account
type: note
---
...
1. [Select the LINE Official Account to link](#select-line-official-account)
2. [Select the LINE MINI App channel to link](#select-line-mini-app-channel)
...
::admonition
---
title: If the developer is also the Business Manager organization administrator
type: tip
---
...
- [Business Manager](https://www.lycbiz.com/jp/service/business-manager/){rel="[\"nofollow\"]"}
- [02. Link an account to an organization](https://www.lycbiz.com/jp/manual/BusinessManager/BMshare003/){rel="[\"nofollow\"]"}
- [03. Organization verification review](https://www.lycbiz.com/jp/manual/BusinessManager/BMshare004/?list=21791){rel="[\"nofollow\"]"}
- [Link other service accounts to a LINE Official Account](https://www.lycbiz.com/jp/manual/BusinessManager/yahoo-display-linkage/){rel="[\"nofollow\"]"}
- [When does the Business Manager review start, what does it review, and how long does it take?](https://help.linebiz.com/lineadshelp/s/article/L000001858?language=ja){rel="[\"nofollow\"]"}
- [Can I transfer a linked account or channel to another organization?](https://help.linebiz.com/lineadshelp/s/article/L000001731?language=ja){rel="[\"nofollow\"]"}
