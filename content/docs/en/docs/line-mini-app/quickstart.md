...
:markdown-controlsLINE MINI App is a web application that runs on LINE.
...
1. Once you create a LINE MINI App channel, you can start [developing a LINE MINI App](/docs/line-mini-app/develop/develop-overview/). At this stage, it'll be published as an unverified MINI App.
2. [Submit your LINE MINI App for Review](/docs/line-mini-app/submit/submission-guide/).
3. If you pass the review, you'll be able to [provide your service](/docs/line-mini-app/service/service-operation/) as a verified MINI App.
...
- [**Check the LINE MINI App Policy**](https://terms2.line.me/LINE_MINI_App?lang=en){rel="[\"nofollow\"]"} In the planning stage, take a look over the LINE MINI App Policy. Before submitting your LINE MINI App for review, make sure that your LINE MINI App abides by the LINE MINI App Policy.
...
- **API References**
  - [Service Message API](/reference/line-mini-app/#service-messages)
  - [LIFF API](/reference/liff/)
  - [LINE Pay API](https://developers-pay.line.me/online-api-v3){rel="[\"nofollow\"]"}
- [**Submit a request for review**](/docs/line-mini-app/submit/submission-guide/): Only those LINE MINI Apps acknowledged to have adhered to guidelines will become verified MINI Apps. To make your LINE MINI App a verified MINI App, submit an application for review.
...
- [**Check the Service Operation Guide**](/docs/line-mini-app/service/service-operation/): For actual operational purposes, make sure you are aware of things like sharing your LINE MINI App via permanent links and sending service messages.

  - [Know-Hows for service providers](/docs/line-mini-app/service/service-operation/)
