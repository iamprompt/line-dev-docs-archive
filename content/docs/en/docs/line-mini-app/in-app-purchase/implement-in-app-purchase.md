...
| Number | Details                                                                                                                                                                                                                                                                                                                                                                                     |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1      | Displays the item name specified at the time of purchase reservation ([`shopProductName`](/reference/line-mini-app/#reserve-purchase-request-body)) as is. Set an appropriate value so that users can recognize the item they purchased.                                                                                                                                                    |
| 2      | Displays the name of LY Corporation's service using in-app purchase and the service name of the service provider using in-app purchase. Note that the service provider's service name is not yet available in multiple languages.   - When the language setting is Japanese: `LINEミニアプリ <Service provider's service name>` - Other cases: `LINE MINI App <Service provider's service name>` |
