...
:markdown-controlsThis page explains how to apply for in-app purchase.

## Things to check prior to applying

Before applying to use in-app purchase, be sure to check the "[In-app purchase overview](/docs/line-mini-app/in-app-purchase/overview/)" and "[In-app purchase development guidelines](/docs/line-mini-app/in-app-purchase/iap-guidelines/)". Also, note the following points.

### Relationship between the in-app purchase review and the verification review

- Even if the in-app purchase review is completed, users can't utilize in-app purchase unless the [verification review (review for publishing as a verified MINI App)](/docs/line-mini-app/submit/submission-guide/) is approved.
...
- After your in-app purchase application is approved, you must apply for the [verification review](/docs/line-mini-app/submit/submission-guide/). This also has a separate review period.
...
Enter the required information on the **In-app purchase** tab in the [LINE Developers Console](/console/).
...
::admonition
---
title: You can cancel your application until review begins
type: tip
---
...
![](/media/line-mini-app/in-app-purchase/tabs-in-iap-tab-en.png){className="[\"border\"]"}

For more information on what to configure in the **In-app purchase settings** tab, see [Set up in-app purchase](/docs/line-mini-app/in-app-purchase/iap-settings/).
...
- If there are changes to the information related to the company, first complete the re-application for [verification review](/docs/line-mini-app/submit/submission-guide/), then re-apply for in-app purchase review.
