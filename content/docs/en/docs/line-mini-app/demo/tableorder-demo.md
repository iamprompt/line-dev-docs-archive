...
:markdown-controls:partial{content="documentation-partials/api-use-case/announcement-of-page/"}Users can complete everything from pre-ordering to payment (including delivery) for products via the LINE MINI App, both inside and outside the store.
...
![](/media/line-mini-app/demo/tableorder-demo/tableorder-en-qr-img.webp){className="[\"w-fix-560\"]"}
...
| ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| ![](/media/line-mini-app/demo/tableorder-demo/tableorder-en-image1.webp){className="[\"w-fix-200\"]"} | ![](/media/line-mini-app/demo/tableorder-demo/tableorder-en-image2.webp){className="[\"w-fix-200\"]"} | ![](/media/line-mini-app/demo/tableorder-demo/tableorder-en-image3.webp){className="[\"w-fix-200\"]"} | ![](/media/line-mini-app/demo/tableorder-demo/tableorder-en-image4.webp){className="[\"w-fix-200\"]"} |
...
![](/media/line-mini-app/demo/tableorder-demo/tableorder-system-diagram-en.webp){className="[\"border\"]"}

- System diagram for using the other services

  - :file-link[
  System diagram using AWS]{file="/media/line-mini-app/demo/tableorder-demo/tableorder-system-diagram-aws-en.webp"}
  - :file-link[
  System diagram using Azure]{file="/media/line-mini-app/demo/tableorder-demo/tableorder-system-diagram-azure-en.webp"}

**Sequence diagram**

![](/media/line-mini-app/demo/tableorder-demo/tableorder-sequence-diagram-en.webp){className="[\"border\"]"}

- Sequence diagram for using the other services

  - :file-link[
  Sequence diagram using AWS]{file="/media/line-mini-app/demo/tableorder-demo/tableorder-sequence-diagram-aws-en.webp"}
  - :file-link[
  Sequence diagram using Azure]{file="/media/line-mini-app/demo/tableorder-demo/tableorder-sequence-diagram-azure-en.webp"}
