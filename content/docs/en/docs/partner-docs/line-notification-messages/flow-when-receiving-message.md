...
__hash__: Nb4O9WIVTf4a6lKtrDjfyqoVGNvYRjYtSyFljn41WLc
seo:
  title: Flow when receiving a LINE notification message
  description: >-
    LINE notification messages is a service that lets you send messages by
...
![User flow when receiving LINE notification messages](/media/line-notification-message/pnp-receive-flow-en.webp){className="[\"w-fix-520\",\"bg-border\"]"}
...
- [Flow for the case where the LINE notification message reception settings are "not set" and SMS authentication isn't needed](#user-consent-flow-for-receiving-line-notification-messages-1)
- [Flow for the case where the LINE notification message reception settings are "not set" and SMS authentication is needed](#user-consent-flow-for-receiving-line-notification-messages-2)
...
| 4      | ![](/media/line-notification-message/type3-pnpflow-4-ja.webp){className="[\"border\",\"w-fix-280\"]"}                                                                                                            | An SMS message will be sent to the specified phone number. Enter the PIN number provided in the message.                                                                                                                                                                                                                                                                                                                                                 |
...
| Number | Image                                                                                                                                                                                                            | Description                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1      | ![](/media/line-notification-message/type2-pnpflow-1-ja.webp){className="[\"border\",\"w-fix-280\"]"}                                                                                                            | If a user has already agreed to receive LINE notification messages and SMS authentication is needed, the "LINE" system account will send the user a "LINE notification message received" message and a "phone number authentication" message when the user receives a LINE notification message.                                                                                                                      |
| 2      | ![](/media/line-notification-message/type2-pnpflow-2-ja.webp){className="[\"border\",\"w-fix-280\"]"}                                                                                                            | Clicking "Set" in the "Phone number authentication" message will take the user to the phone number authentication screen.                                                                                                                                                                                                                                                                                             |
| 3      | ![](/media/line-notification-message/type2-pnpflow-3-ja.webp){className="[\"border\",\"w-fix-280\"]"}                                                                                                            | When the "Send SMS" button is pressed, a confirmation dialog box for sending an SMS message to the phone number registered in the LINE account will be displayed. Note that if the user taps **Change** in this dialog to change the phone number to which the SMS is sent (the phone number registered in the LINE account), LINE notification messages sent to the old phone number won't be delivered to the user. |
| 4      | ![](/media/line-notification-message/type2-pnpflow-4-ja.webp){className="[\"border\",\"w-fix-280\"]"}                                                                                                            | An SMS message will be sent to the specified phone number. Enter the PIN number provided in the message.                                                                                                                                                                                                                                                                                                              |
| 5      | ![](/media/line-notification-message/type1-pnpflow-3-ja.webp){className="[\"border\",\"w-fix-280\"]"}      ![](/media/line-notification-message/type1-pnpflow-4-ja.webp){className="[\"border\",\"w-fix-280\"]"} | Once the SMS verification is completed, the "LINE" system account will send a "LINE Notification Message Received" message to the user. At the same time, the requested LINE notification message will be sent to the user.                                                                                                                                                                                           |
...
| 3      | ![](/media/line-notification-message/change-phone-number-3-ja.webp){className="[\"border\",\"w-fix-280\"]"} | After successfully authenticating your phone number via SMS, you'll receive a "Your phone number has been changed" message from your LINE account. |
