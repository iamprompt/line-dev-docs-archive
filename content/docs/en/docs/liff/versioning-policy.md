...
:markdown-controlsTo integrate the appropriate LIFF SDK into your LIFF app, make sure to understand the LIFF Versioning policy.
...
::admonition
---
title: Backwards compatible CDN path discontinuation
type: note
---
