...
:markdown-controlsBy managing provider and channel roles, you can control the information that developers can view and edit on the [LINE Developers Console](/console/). This page describes the types of roles that can be assigned to developers registered on providers and channels.
...
::admonition{title="On provider roles and channel roles" type="note"}
...
::admonition
---
title: What is the difference between "Member" and "No role" on the provider?
type: tip
---
...
1. Select provider from the [LINE Developers Console](/console/) sidebar.
2. Click **Roles** tab.| Action | Steps                                                                                                                                                                                                                                                                                                                     |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
- [Common to all channel types](#roles-for-channel-common)
- [LINE Login channel](#roles-for-channel-line-login)
- [Messaging API channel](#roles-for-channel-messaging-api)
- [LINE MINI App channel](#roles-for-channel-line-mini-app)
...
*2 Only displayed in the LINE Login channel or the Messaging API channel. In either role, **Your user ID** won't be displayed if your Business ID that isn't linked to a LINE account. For more information, see [Available features](/docs/line-developers-console/login-account/#available-features).  
*3 Only displayed in the LINE MINI App channel.  
*4 You can't delete the Blockchain Service channel or the LINE MINI App channel.
...
Only the LINE Login channel, the LINE MINI App channel, and the Blockchain service channel have a status. For testing methods after you've granted Tester role to your developer account in the LINE Login channel, see [How to test with a LINE Login channel with the "Developing" status](/docs/line-login/getting-started/#how-to-test-login-channel).
...
Open the **Roles** tab of the channel on the [LINE Developers Console](/console/).
...
---
title: >-
  Restrictions on adding a developer with an Admin role in Messaging API
  channels
type: note
---
...
This is because it conflicts with the "LINE Official Account Manager restrictions" described in [The number of channels that can be created](/docs/line-developers-console/overview/#number-of-channels).
::
...
::admonition{title="Note when you receive an invitation" type="note"}
