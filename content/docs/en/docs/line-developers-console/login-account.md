...
__hash__: b85kwygQFugLbImaU_cIl0CF_6a6sfQmwBdY01B2oU4
seo:
  title: Log in to the LINE Developers Console
  description: null
---
...
:markdown-controlsTo log in to the [LINE Developers Console](/console/), you need your [Business ID](https://help2.line.me/business_id/web/?lang=en&contentId=20011264){rel="[\"nofollow\"]"} and developer account.
...
To log in to the LINE Developers Console, click the **[Log in to Console](/console/)** button in the top-right corner of the [LINE Developers site](/).

![Click Log in to Console](/media/line-developers-console/login-account-02-en.png){className="[\"border\",\"w-fix-920\"]"}
...
- [Yahoo! JAPAN ID](#yahoo-japan-id) (Only available in Japan)

For more information about the difference between login methods, see [Business ID login methods](https://help2.line.me/business_id/web/?lang=en&contentId=20011265){rel="[\"nofollow\"]"} in the Help Center.

![](/media/line-developers-console/login-account-01-en.png){className="[\"border\",\"w-fix-360\"]"}
...
::admonition
---
title: Two-factor authentication is enabled when logging in with LINE account
type: tip
---
...
![Two-factor authentication flow](/media/news/login-flow-with-2fa-en.png){className="[\"w-fix-760\"]"}

Once two-factor authentication is executed, the browser used to log in won't require two-factor authentication again for one year. Also, if you've already logged in to [LINE Official Account Manager](https://manager.line.biz/){rel="[\"nofollow\"]"} using two-factor authentication, you won't be required to log in to the LINE Developers Console with the same account.
::
...
When logging in to your Business ID with your Yahoo! JAPAN ID, you must link your Yahoo! JAPAN ID to [Yahoo! JAPAN Business ID](https://support.yahoo-net.jp/PccBizmanager/s/article/H000011271){rel="[\"nofollow\"]"} (only available in Japanese).

Note that logging in to your Business ID using your Yahoo! JAPAN ID is only available in Japan.

For more information about how to log in with your Yahoo! JAPAN ID, see [What are the available login methods?](https://id.yahoo.co.jp/login/login_methods.html){rel="[\"nofollow\"]"} (only available in Japanese) in the Yahoo! JAPAN ID Guide.

## Create a developer account (only on first login)

When you first log in to the [LINE Developers Console](/console/) with your LINE account or business account, create a developer account. Enter **Developer name** and **Your email**. Read carefully and agree to the [LINE Developers Agreement](https://terms2.line.me/LINE_Developers_Agreement?lang=en){rel="[\"nofollow\"]"}. Click **Create my account**. This step is only required on first login.

![Developer account creation screen](/media/line-developers-console/developer-registration-01-en.webp){className="[\"border\",\"w-fix-520\"]"}
...
![Developer account creation completion screen](/media/line-developers-console/developer-registration-02-en.webp){className="[\"border\",\"w-fix-520\"]"}

## Account relationships

You need a developer account to use the LINE Developers Console. In addition, a developer account is always linked to a Business ID on a one-to-one basis. When you first log in to the LINE Developers Console and [create a developer account](#register-as-developer), your Business ID and developer account will be automatically linked.

::admonition
---
title: Note on linking your developer account to your Business ID
type: note
---
...
* When you [create a developer account](#register-as-developer), your Business ID will automatically be linked to your developer account.

::admonition{title="About the email address for each account" type="tip"}
...
| Business account   (email address and password) | None (*)                                     |

* You can link a LINE account to your Business ID created with a business account at any time. For more information, see [Link your Business ID with your LINE account](#link-business-account-with-line-account).
...
![Click the icon in the top-right corner of the screen](/media/line-developers-console/linking-line-account-click-user-icon-en.png){className="[\"border\",\"w-fix-560\"]"}
3. Click the account information, and then open the profile screen  
![Click account information](/media/line-developers-console/linking-line-account-click-account-en.png){className="[\"border\",\"w-fix-240\"]"}
4. Click the **Go to Business ID Profile** button to go to your Business ID profile  
![Click the Go to Business ID profile](/media/line-developers-console/linking-line-account-click-business-id-en.png){className="[\"border\",\"w-fix-560\"]"}
5. Click the link icon next to "Unlinked" on the LINE account section  
![Link to LINE account](/media/line-developers-console/linking-line-account-click-link-icon-en.png){className="[\"border\",\"w-fix-240\"]"}
6. Log in to the LINE account you want to link your Business ID with
7. Once login to your LINE account is complete, the LINE account will be linked to the Business ID

::admonition
---
title: >-
  When the message "This LINE account is already in use." is displayed when
  linking your LINE account
type: note
---
...
![Link to LINE account](/media/line-developers-console/login-account-04-en.png){className="[\"border\",\"w-fix-360\"]"}
::

::admonition
---
title: Linking a developer account with a LINE account
type: tip
---
...
1. Log in to the [LINE Developers Console](/console/) with the Business ID you want to unlink your LINE account from
2. Click the icon in the top-right corner of the screen  
![Click the icon in the top-right corner of the screen](/media/line-developers-console/linking-line-account-click-user-icon-en.png){className="[\"border\",\"w-fix-560\"]"}
3. Click the account information, and then open the profile screen  
![Click account information](/media/line-developers-console/linking-line-account-click-account-en.png){className="[\"border\",\"w-fix-240\"]"}
4. Click the **Go to Business ID Profile** button to go to your Business ID profile  
![Click the Go to Business ID Profile](/media/line-developers-console/linking-line-account-click-business-id-en.png){className="[\"border\",\"w-fix-560\"]"}
5. Click the delete icon on the LINE account section
...
![Unlink LINE account](/media/line-developers-console/unlink-business-account-with-line-account-en.png){className="[\"border\",\"w-fix-240\"]"}
6. Click **Delete** on the confirmation screen  
![Click Delete on the confirmation screen](/media/line-developers-console/unlink-business-account-click-delete-en.png){className="[\"border\",\"w-fix-240\"]"}
...
Depending on the roles assigned to the developer account you're using, there are restrictions on the features you can use. For more information, see [Managing roles](/docs/line-developers-console/managing-roles/).
