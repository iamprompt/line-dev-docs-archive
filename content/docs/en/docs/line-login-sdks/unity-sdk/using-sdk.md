...
:markdown-controls## Calling LINE APIs with result handling
...
- [Handling errors for LINE SDK for iOS Swift](/docs/line-login-sdks/ios-sdk/swift/error-handling/)
- [Handling errors for LINE SDK for Android](/docs/line-login-sdks/android-sdk/handling-errors/)
- [Error API reference and definition for Swift](/reference/ios-sdk-swift/Enums/LineSDKError.html)
- [Error API reference and definition for Android](/reference/android-sdk/reference/com/linecorp/linesdk/LineApiResponseCode.html)
...
Server-side code can make LINE Login API calls using access tokens. To learn more, see the [LINE Login v2.1 API reference](/reference/line-login/).
