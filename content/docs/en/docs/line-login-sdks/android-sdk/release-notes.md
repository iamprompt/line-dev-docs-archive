...
type: note
---
Release notes for LINE SDK for Android version 5.0.0 or later are available on the GitHub repository. For more information, see [Releases](https://github.com/line/line-sdk-android/releases){rel="[\"nofollow\"]"}.
::
...
The LINE SDK 5.0.0 for Android has been released. For installation and usage instructions, see the [LINE SDK for Android guide](/docs/line-login-sdks/android-sdk/).
...
From version 5.0.0, the LINE SDK for Android is open-sourced. Visit [our repository](https://github.com/line/line-sdk-android){rel="[\"nofollow\"]"} to check the provided code and samples.

##### Detailed reference

Now you can access detailed reference based on the source code. For more information, see the [LINE SDK for Android reference](/reference/android-sdk/).
