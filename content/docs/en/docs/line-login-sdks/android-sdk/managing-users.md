...
seo:
  title: Managing users
  description: >-
    Getting user profile and ID tokens after login with the LINE SDK for
    Android.
---
...
::admonition{title="User spoofing" type="warning"}
...
- [Verify ID token](/reference/line-login/#verify-id-token) (LINE Login v2.1 API reference)
