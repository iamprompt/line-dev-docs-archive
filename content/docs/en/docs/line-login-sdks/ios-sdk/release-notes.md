...
__hash__: 2tbYAkEnO908jhIZ3oG7cEvZuQBj_Sx3v1NSQzGBuro
seo:
  title: Release notes
  description: Release notes for the LINE SDK for iOS. See the latest changes and releases.
---
...
---
title: >-
  Release notes for version 5.0.0 or later are available on the GitHub
  repository
type: note
---
Release notes for LINE SDK for iOS version 5.0.0 or later are available on the GitHub repository. For more information, see [Releases](https://github.com/line/line-sdk-ios-swift/releases){rel="[\"nofollow\"]"}.
::
...
The LINE SDK 5.0.0 for iOS has been released. For installation and usage instructions, see the [LINE SDK for iOS guide](/docs/line-login-sdks/ios-sdk/).
...
The LINE SDK for iOS Swift is open-sourced. Visit [our repository](https://github.com/line/line-sdk-ios-swift){rel="[\"nofollow\"]"} to check the provided code and samples.

##### Detailed reference

Now you can access detailed reference based on the source code. For more information, see the followings:

- [LINE SDK for iOS Swift reference](/reference/ios-sdk-swift/)
- [LINE SDK for iOS Objective-C reference](/reference/ios-sdk-objc/)
