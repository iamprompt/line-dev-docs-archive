...
navigation: true
description: >-
  The LINE SDK for iOS Swift reports errors in detail. Handle reported errors so
...
seo:
  title: Handling errors
  description: >-
    The LINE SDK for iOS Swift reports errors in detail. Handle reported errors
    so that your users can see how to recover from errors.
---
