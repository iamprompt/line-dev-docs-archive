...
:markdown-controlsFollow the development guidelines below when developing using LINE Ads API:

:toc## Prohibiting mass requests to the LINE Platform

Don't send a large number of requests to the LINE Platform for the purpose of load testing or operation testing.

Don't send requests beyond the specified rate limits for any purpose. For more information about rate limits, see [Ad Tech API documentation](https://ads.line.me/public-docs/certificated-ad-tech-general-partner){rel="[\"nofollow\"]"} and [Data Provider API documentation](https://ads.line.me/public-docs/data-general-partner){rel="[\"nofollow\"]"}.
